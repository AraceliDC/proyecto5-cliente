...
import BackgroundJumbotron from './../assets/anaranjado.png'
              ...
              <div className="relative shadow-xl sm:rounded-2xl sm:overflow-hidden">
                ...
                <div className="relative px-4 py-16 sm:px-6 sm:py-24 lg:py-32 lg:px-8">
                  <h1 className="text-center text-4xl font-extrabold tracking-tight sm:text-5xl lg:text-6xl">
                    <span className="block text-white">La polera mas canchera del universo</span>
                    <span className="block text-white">te está esperando.</span>
                  </h1>
                  <p className="mt-6 max-w-lg mx-auto text-center text-xl text-white sm:max-w-3xl">
                    Contamos con gran variedad e poleras, despacho a todo Chile bbys.
                  </p>
                  <div className="mt-10 max-w-sm mx-auto sm:max-w-none flex justify-center">
                    <div className="space-y-4 sm:space-y-0 sm:mx-auto sm:inline-grid  sm:gap-5">
                      <Link to="/catalogo">
                        <a className="flex items-center justify-center px-4 py-3 border border-transparent text-base text-white font-medium rounded-md shadow-sm bg-gray-900 hover:bg-gray-500 sm:px-8">
                          Ver catálogo
                        </a>
                      </Link>
                    </div>
