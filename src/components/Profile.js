                                        ...
                                        <div className="sm:col-span-6">
                                            ...
                                            <div>
                                                <select
                                                    ...
                                                    className='p-1 border border-gray shadow-sm px-3 rounded focus:outline-none focus:ring-purple-600 focus:border-transparent block w-full pr-6 sm:text-m border-gray-300'
                                                    value={userForm.country}
                                                    onChange={handleChange}
                                                >
                                                    {countries.map((countryOption, index) => (<option key={index} value={countryOption}>
                                                        {countryOption}
                                                    </option>))}
                                                </select>
                                            </div>
